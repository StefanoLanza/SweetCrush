...
Wind::UIButton*   MakeMenuButton(Wind::UIPanel& container, float y, Wind::StringId label, const Wind::Color& color = button0_color,
                                 const char* icon = nullptr);
Wind::UIButton*   MakeBackButton(Wind::UIPanel& container);
Wind::UIButton*   MakeCloseButton(Wind::UIPanel& container);
Wind::UIButton*   MakeCheckBox(Wind::UIPanel& container, float y, Wind::StringId label, const Wind::Color& color);
