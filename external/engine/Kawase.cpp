...
KawaseBlur::Impl::Impl(Graphics& graphics)
    : mGraphics { graphics }
    , mDownsampleProgram { graphics.NewProgram("fullscreenTriangle.vs", "postprocess/kawaseDownsample.fs") }
    , mUpsampleProgram { graphics.NewProgram("fullscreenTriangle.vs", "postprocess/kawaseUpsample.fs") }
